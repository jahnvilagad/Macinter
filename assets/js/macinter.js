...
!function() {
    ...
    e.contains("navbar-floating") && e.contains("navbar-dark") ? window.addEventListener("scroll", function(e) {
        ...
        r.classList.add("navbar-light", "navbar-stuck")) : (r.classList.remove("navbar-light", "navbar-stuck"),
    ...
    function() {
        ...
        if (null !== t)
            for (var r = t.querySelector(".navbar-search-field"), a = 0; a < e.length; a++)
    ...
    null != (n = document.querySelector(".btn-scroll-top")) && (a = parseInt(600, 10),
    window.addEventListener("scroll", function(e) {
    ...
    function(e, t, r) {
        ...
        if (null != l) {
            for (var s = l.querySelectorAll("[data-goto]"), c = 0; c < s.length; c++)
                s[c].addEventListener("click", function(e) {
                    a.goTo(this.dataset.goto - 1),
                    e.preventDefault()
                });
        ...
        null !== n.querySelector(".tns-carousel-progress") && (r = a.getInfo(),
    ...
    function() {
        ...
        if (0 !== e.length || 0 !== t.length || 0 !== l.length) {
            ...
            for (var v = 0; v < t.length; v++) {
                var p, m = JSON.parse(t[v].dataset.barChart), h = null != t[v].dataset.options ? JSON.parse(t[v].dataset.options) : "", g = t[v].dataset.seriesColor;
                if (t[v].classList.add("bar-chart-" + v),
                null != g) {
                    p = JSON.parse(g);
    ...
    function() {
        ...
        if (o.length)
            for (var e = 0; e < o.length; e++)
                !function(r) {
                    for (var a = o[r].querySelectorAll(".product-gallery-thumblist-item"), n = o[r].querySelectorAll(".product-gallery-preview-item"), e = 0; e < a.length; e++)
                    ...
                    function t(e) {
                        ...
                        this.classList.add("active"),
                        o[r].querySelector(this.getAttribute("href")).classList.add("active")
                    }
                }(e)
    }(),
    function() {
                ...
                e[t].addEventListener("change", function() {
                    ...
                    if (this.checked)
                        ...
                        for (var r = 0; r < e.length; r++)
                            e[r].checked = !1,
                            e[r].dataset.checkboxToggleClass && document.querySelector(e[r].dataset.bsTarget).classList.remove(e[r].dataset.checkboxToggleClass)
                })
    }()
}();
