...
;(function ($, window) {
  ...
  function buildNavTabsAndTabContentForTargetElementInstance($targetElInstance, settings, readyCallback) {
    ...
    $scroller.find('.nav-pills > li').each(function (index) {
  ...
  function refreshDataDrivenTabs($container, options) {
    var instanceData = $container.data().scrtabs,
        ...
        $navTabs = $container.find('.scrtabs-tab-container .nav-pills'),
  ...
  $.fn.scrollingTabs.defaults = {
    ...
    cssClassLeftArrow: 'left',
    cssClassRightArrow: 'right',
    leftArrowContent: '',
    rightArrowContent: '',
    enableSwiping: false
  };
